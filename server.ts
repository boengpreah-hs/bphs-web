...
const defaultAbout = {
  title: 'វិទ្យាល័យបារាយណ៍',
  details: 'វិទ្យាល័យបារាយណ៍ គឺជាគ្រឹះស្ថានសិក្សាសាធារណៈគំរូមួយដែលបានបណ្តុះបណ្តាលសិស្សានុសិស្សប្រកបដោយគុណភាព វិន័យ សីលធម៌ និងការទទួលខុសត្រូវខ្ពស់។ យើងខ្ញុំផ្តោតសំខាន់លើការអភិវឌ្ឍសមត្ថភាពរៀនសូត្ររបស់សិស្សគ្រប់កម្រិតថ្នាក់។',
  phone: '0966187972',
